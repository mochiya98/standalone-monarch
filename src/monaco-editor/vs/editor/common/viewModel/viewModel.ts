...
type EndOfLinePreference = any;
type IActiveIndentGuideInfo = any;
type IModelDecorationOptions = any;
type TextModelResolvedOptions = any;
type IScrollPosition = any;
type Scrollable = any;
type INewScrollPosition = any;
type IViewEventListener = any;
type IPartialViewLinesViewportData = any;
type IEditorWhitespace = any;
